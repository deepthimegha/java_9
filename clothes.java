package com.shoppse;
	...
	class Clothes extends myclass {

		String[] products = { "Mackly", "Firstcry", "Kinderjoy", "Nike", "Gucci", "Oneeight", "banaras", "silk","Dresses" };
		...
		public void kids() {
			String repeat = "no";
			do {
				System.out.println("1.Mackly");
				System.out.println("2.Firstcry");
				System.out.println("3.Kinderjoy");

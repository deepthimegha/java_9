package com.shoppse;
	...
	class jewellery extends myclass {

		String[] products = { "lalitha", "joyalukas", "kalyan", "malabar", "ganesh", "srilashmi", "chandan", "katyayini","durga" };
		...
		public void rings() {
			String repeat = "no";
			do {
				System.out.println("1.laitha");
				System.out.println("2.joyalukas");
				System.out.println("3.kalyan");
				System.out.println("please Select the option ");
				int jewelleryopt= sc.nextInt();
